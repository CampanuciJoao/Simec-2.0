...
// VERSÃO FINAL SÊNIOR - COM ROTAS DE DETALHES DE CONTRATOS E SEGUROS
...
import LogAuditoriaPage from '@/pages/LogAuditoriaPage';
import DetalhesEquipamentoPage from '@/pages/DetalhesEquipamentoPage';
import DetalhesManutencaoPage from '@/pages/DetalhesManutencaoPage';
import CadastrosGeraisPage from '@/pages/CadastrosGeraisPage';
import EquipamentosPage from '@/pages/EquipamentosPage';
import SalvarEquipamentoPage from '@/pages/SalvarEquipamentoPage';
import UnidadesPage from '@/pages/UnidadesPage';
import SalvarUnidadePage from '@/pages/SalvarUnidadePage';
import ContratosPage from '@/pages/ContratosPage';
import SalvarContratoPage from '@/pages/SalvarContratoPage';
import ManutencoesPage from '@/pages/ManutencoesPage';
import SalvarManutencaoPage from '@/pages/SalvarManutencaoPage';
import SegurosPage from '@/pages/SegurosPage';
import SalvarSeguroPage from '@/pages/SalvarSeguroPage';
import AuditoriaDetalhadaPage from '@/pages/AuditoriaDetalhadaPage';
import EmailsNotificacaoPage from '@/pages/EmailsNotificacaoPage';

// NOVOS COMPONENTES: Páginas de Detalhes (por enquanto, placeholders)
import DetalhesContratoPage from '@/pages/DetalhesContratoPage'; // Será criado
import DetalhesSeguroPage from '@/pages/DetalhesSeguroPage';     // Será criado

/**
 * Componente raiz da aplicação que define toda a estrutura de roteamento.
 */
function App() {
    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/" element={<ProtectedRoute><AppLayout /></ProtectedRoute>}>
          ...
          {/* Rota de Detalhes do Equipamento (já existia) */}
          ...
          <Route path="contratos">
            ...
            {/* NOVO: Rota para detalhes de contrato */}
          ...
          <Route path="seguros">
            ...
            {/* NOVO: Rota para detalhes de seguro */}
